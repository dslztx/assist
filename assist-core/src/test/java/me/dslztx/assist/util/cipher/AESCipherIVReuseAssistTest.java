...
@Slf4j
public class AESCipherIVReuseAssistTest {
    ...
    public void test0() {
        try {
            ...
            while ((count--) > 0) {
                ...
                byte[] cipherData = AESCipherIVReuseAssist.encrypt(s.getBytes("utf-8"));

                byte[] decipherData = AESCipherIVReuseAssist.decrypt(cipherData);
